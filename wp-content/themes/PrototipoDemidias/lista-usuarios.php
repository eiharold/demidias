<?php
//Template Name: Lista de Usuarios
?>
...
<section class="bg-filtros">
     <div class="filtros">
          ...
          <b><a class="ordemza" href="<?php echo esc_url( home_url( '/' ) ); ?>artistas-za">Ordem Z-A <span class="setinha">&#9662;</span></a></b>
     </div>
</section>
<div class="corpo">
<div class="autores">
<?php
     ...
     foreach($authors as $author) {
          ...
          echo '<li class="autor">';
          echo '<center><div class="author-gravatar"><a href="', $author_profile_url, '">', $avatar , '</a></div>';
          echo '<div class="author-name"><h4><a href="', $author_profile_url, '" class="contributor-link">', $display_name, '</a></h4></div>';
          echo '<div class="quantidade-trabalhos"><a href="', $author_profile_url, '" class="contributor-link">', count_user_posts($author['ID']), ' trabalho(s)</a></h4></div>';
