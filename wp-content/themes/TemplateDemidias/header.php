	...
	<div class="bg-barra-topo">
		<div class="barra-topo">
			...
			<div class="botoes-topo">
				...
				<?php endif; ?>
				<?php if ( is_user_logged_in() ): ?>
						<iframe id="iframeLogado" scrolling="no" src="<?php echo esc_url( home_url( '/' ) ); ?>login-interno"></iframe>
	...
	<div class="bg-cabecalho">
		<div class="titulo-cabecalho">
			<h1>
				...
				<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/titulo-demidias.png">
				</a>
			</h1>
		</div>
	</div>
