    ...
    public static function fields( $item_id, $item, $depth, $args ) {
            ...
            (function ($, $document) {
                ...
                function which_users() {
                    ...
                    if ($this.val() === 'logged_in') {
                        ...
                        $roles.slideUp();
                        $subs.slideDown();
                        $item.removeClass('.nav_item_options-roles');
                    } else {
                        $roles.slideUp();
                        $subs.slideUp();
                        $item.removeClass('.nav_item_options-sub-packs');
                ...
                $('.submit-add-to-menu').click(function () {
                    ...
                    $this.removeClass('.nav_item_options-roles');
        ...
        <?php
            ...
            <p class="nav_item_options-which_users  description  description-wide">
                ...
                <label for="wpuf_nav_item_options-which_users-<?php echo $item->ID; ?>">

                    <?php _e( 'Who can see this link?', 'wpuf-pro' ); ?><br />

                    <select name="wpuf_nav_item_options[<?php echo $item->ID; ?>][which_users]" id="wpuf_nav_item_options-which_users-<?php echo $item->ID; ?>" class="widefat">
            ...
            <p class="nav_item_options-roles  description  description-wide">
                ...
                <?php foreach ( $allowed_user_roles as $option => $label ) : ?>
                    <label>
                        <input type="checkbox" name="wpuf_nav_item_options[<?php echo $item->ID; ?>][roles][]" value="<?php echo $option; ?>" <?php checked( in_array( $option, $item->roles ), true ); ?>/>
                        <?php echo esc_html( $label ); ?>
                    </label>
                <?php endforeach; ?>
