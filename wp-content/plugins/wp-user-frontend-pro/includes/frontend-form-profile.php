...
class WPUF_Frontend_Form_Profile extends WPUF_Render_Form {
    ...
    function shortcode_handler( $atts ) {
        ...
        if ( $type == 'profile' ) {
            ...
            if ( is_user_logged_in() ) {
                ...
                echo '<div class="wpuf-info">' . __( '<center>Faça login para atualizar seus dados</center>', 'wpuf-pro' ) . '</div>';
            }
        } elseif ( $type == 'registration' ) {

            if ( is_user_logged_in() ) {
                echo '<div class="wpuf-info">' . __( '<center>Você já está logado!</center>', 'wpuf-pro' ) . '</div>';
            } else {
    ...
    function user_register() {
        ...
        if ( $this->search( $user_vars, 'name', 'user_login' )) {
            ...
            if ( username_exists( $username ) ) {
                $this->send_error( __( 'Username already exists.', 'wpuf-pro' ) );
            }
        }
    ...
    function send_verification_mail( $user_id, $user_email ) {
        ...
        wp_mail( $user_email, sprintf(__('[%s] Account Activation', 'wpuf-pro' ), $blogname), $message);
    }
