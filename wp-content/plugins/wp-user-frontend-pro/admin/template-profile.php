...
class WPUF_Admin_Template_Profile extends WPUF_Admin_Template {
    ...
    public static function password( $field_id, $label, $values = array() ) {
        ...
        $re_pass_label_value = isset( $values['re_pass_label'] ) ? $values['re_pass_label'] : __( 'Confirm Password', 'wpuf-pro' );
        ?>
        <li class="password">
            <?php self::legend( $label, $values, $field_id ); ?>
            ...
            <div class="wpuf-form-holder">
                ...
                <div class="wpuf-form-rows">
                    <label><?php _e( 'Minimum password length', 'wpuf-pro' ); ?></label>

                    <input type="text" name="<?php echo $min_length_name ?>" value="<?php echo esc_attr( $min_length_value ); ?>" />
                </div> <!-- .wpuf-form-rows -->

                <div class="wpuf-form-rows">
                    <label><?php _e( 'Password Re-type', 'wpuf-pro' ); ?></label>
                ...
                <div class="wpuf-form-rows<?php echo $pass_repeat_value != 'yes' ? ' wpuf-hide' : ''; ?>">
                    ...
                    <div class="wpuf-form-sub-fields">
                        <label>
                            ...
                            <?php _e( 'Show password strength meter', 'wpuf-pro' ); ?>
                        </label>
                    </div>
                </div> <!-- .wpuf-form-rows -->
                <?php self::conditional_field( $field_id, $values ); ?>
