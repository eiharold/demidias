...
<center><h2>Realizar Cadastro</h2>
<p class="contexto">Preencha os campos abaixo com seus dados<br> para efetuar o cadastro.</p></center>
    <?php
    ...
    <form name="registrationform" class="wpuf-registration-form" id="registrationform" action="<?php echo $action_url; ?>" method="post">
        ...
        <ul class="wpuf-form form-label-above">
            <li>
                <div class="wpuf-label"><?php _e( 'Nome', 'wp-user-frontend' ); ?> <span class="required">*</span></div>
                <div class="wpuf-fields">
                    <div class="wpuf-name-field-wrap format-first-last">
                        <div class="wpuf-name-field-first-name">
                            ...
                            <label class="wpuf-form-sub-label"><?php _e( 'Primeiro', 'wp-user-frontend' ); ?></label>
                        </div>
                        ...
                        <div class="wpuf-name-field-last-name">
                            ...
                            <label class="wpuf-form-sub-label"><?php _e( 'Último', 'wp-user-frontend' ); ?></label>
                        </div>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="wpuf-label"><?php _e( 'Nome de Usuário', 'wp-user-frontend' ); ?> <span class="required">*</span></div>
                <div class="wpuf-fields">
            ...
            <li>
                <div class="wpuf-label"><?php _e( 'Senha', 'wp-user-frontend' ); ?> <span class="required">*</span></div>
                <div class="wpuf-fields">
            ...
            <li>
                <div class="wpuf-label"><?php _e( 'Confirmar Senha', 'wp-user-frontend' ); ?> <span class="required">*</span></div>
                <div class="wpuf-fields">
            ...
            <li class="wpuf-submit">
                <input type="submit" name="wp-submit" id="wp-submit" value="<?php esc_attr_e( 'Cadastrar', 'wp-user-frontend' ); ?>" />
