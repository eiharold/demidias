...
class WPUF_Render_Form {
    ...
    function password( $attr, $post_id, $type, $form_id ) {
        ...
        if ( $pass_strength ) {
            ...
            <div class="wpuf-fields">
                <div id="pass-strength-result" style="display: block"><?php _e( 'Força da senha', 'wp-user-frontend' ); ?></div>
            </div>
    ...
    function image_upload( $attr, $post_id, $type, $form_id ) {
        ...
        $button_label = empty( $attr['button_label'] ) ? __( 'Selecionar Imagem', 'wp-user-frontend' ) : $attr['button_label'];
        ?>
