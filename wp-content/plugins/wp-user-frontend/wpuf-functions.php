...
function wpuf_get_account_sections() {
    $account_sections = array(
        array( 'slug' => 'dashboard', 'label' => __( 'Painel de Controle', 'wp-user-frontend' ) ),
        array( 'slug' => 'posts', 'label' => __( 'Trabalhos', 'wp-user-frontend' ) ),
        array( 'slug' => 'edit-profile', 'label' => __( 'Editar Perfil', 'wp-user-frontend' ) ),
